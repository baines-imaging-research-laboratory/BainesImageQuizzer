...
#        required referenced series to the calling app.
...
class DICOMDetailsBase(VTKObservationMixin, SizePositionSettingsMixin):
  ...
  def showReferenceDialogAndProceed(self):
    ...
    #########################################################
    #
    # Disable showing the dialog popup for loading referenced datasets
    # Set the remember box to true and set the answer to NO since
    #     the Image Quizzer handles loading the appropriate datasets.
    
    #    answer = referencesDialog.exec_()
    referencesDialog.rememberChoiceAndStopAskingCheckbox.setChecked(True)
    answer = qt.QMessageBox.No
