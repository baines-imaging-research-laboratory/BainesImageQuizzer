...
class EditBox(VTKObservationMixin):
  ...
  def __init__(self, parent=None, optionsFrame=None):
    ...
    self.editorBuiltins = {}
    self.editorBuiltins["PaintEffect"] = QuizzerEditorLib.PaintEffect
    self.editorBuiltins["DrawEffect"] = QuizzerEditorLib.DrawEffect
    self.editorBuiltins["ThresholdEffect"] = QuizzerEditorLib.ThresholdEffect
    self.editorBuiltins["RectangleEffect"] = QuizzerEditorLib.RectangleEffect
    self.editorBuiltins["LevelTracingEffect"] = QuizzerEditorLib.LevelTracingEffect
    self.editorBuiltins["MakeModelEffect"] = QuizzerEditorLib.MakeModelEffect
    self.editorBuiltins["ErodeEffect"] = QuizzerEditorLib.ErodeEffect
    self.editorBuiltins["DilateEffect"] = QuizzerEditorLib.DilateEffect
    self.editorBuiltins["ChangeLabelEffect"] = QuizzerEditorLib.ChangeLabelEffect
    self.editorBuiltins["RemoveIslandsEffect"] = QuizzerEditorLib.RemoveIslandsEffect
    self.editorBuiltins["IdentifyIslandsEffect"] = QuizzerEditorLib.IdentifyIslandsEffect
    self.editorBuiltins["SaveIslandEffect"] = QuizzerEditorLib.SaveIslandEffect
    self.editorBuiltins["ChangeIslandEffect"] = QuizzerEditorLib.ChangeIslandEffect
    self.editorBuiltins["GrowCutEffect"] = QuizzerEditorLib.GrowCutEffect
    self.editorBuiltins["WatershedFromMarkerEffect"] = QuizzerEditorLib.WatershedFromMarkerEffect
    self.editorBuiltins["FastMarchingEffect"] = QuizzerEditorLib.FastMarchingEffect
    self.editorBuiltins["WandEffect"] = QuizzerEditorLib.WandEffect
  ...
  def findEffects(self, path=""):
    ...
    iconDir = QuizzerEditorLib.ICON_DIR
  ...
  def create(self):
    ...
    self.createButtonRow( ("DefaultTool", "EraseLabel", "PaintEffect", "DrawEffect", "ChangeLabelEffect") )
